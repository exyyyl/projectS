...
@EventBusSubscriber(modid = Projects.MODID, bus = EventBusSubscriber.Bus.MOD)
public class Config {
    ...
    // Client config for keybindings
    private static final ModConfigSpec.Builder CLIENT_BUILDER = new ModConfigSpec.Builder();

    private static final ModConfigSpec.ConfigValue<String> TIME_STOP_KEY = CLIENT_BUILDER
            .comment("Key to toggle time stop (default: GRAVE which is ~)")
            .define("timeStopKey", "key.keyboard.grave.accent");
    ...
    public static String timeStopKey;
